/*  
  ...
  This is converted into a value from 0 to 1023. We are using a photoresitor
...
//This is the value each LDR outputs. It will range from 0-1023 because we are using a 10 bit converter.
int brightness0 = 0; 
int brightness1 = 0; 
int brightness2 = 0; 
int brightness3 = 0; 
...
void setup() {
   //Open the serial communications between the computer and the Arduino.
  Serial.begin(9600);
  
  //Create a header here, because we only need it once.
